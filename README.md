...
|---|---|---|
| 2026-06-23 | BFS | [Agentic AI Design Patterns: Supervisor Architecture with Nested Patterns — BFSI Loan Underwriting Case Study](./bfs/bfsi-loan-application-supervisor-agent-nested-patterns.md) |
